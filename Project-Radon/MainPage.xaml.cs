    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            if (inlineMode == "True")
            {
                ...
                DefaultBarUI.Height = new Microsoft.UI.Xaml.GridLength(0);
            ...
            else
            {
                ...
                DefaultBarUI.Height = new Microsoft.UI.Xaml.GridLength(40);
        ...
        private void CoreWindow_Activated(CoreWindow sender, Microsoft.UI.Xaml.WindowActivatedEventArgs args)
        {
        ...
        private void fullscreenbutton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (view.IsFullScreenMode)
            {
                ...
                BrowserTabs.Margin = new Microsoft.UI.Xaml.Thickness(0, 0, 0, 0);
                DefaultBarUI.Height = new Microsoft.UI.Xaml.GridLength(40);
            ...
            else
            {
                ...
                ApplicationView.PreferredLaunchWindowingMode = ApplicationViewWindowingMode.Auto;
                fullscreenbutton_icon.Glyph = "\uE73F";
                BrowserTabs.Margin = new Microsoft.UI.Xaml.Thickness(0, -40, 0, 0);
                DefaultBarUI.Height = new Microsoft.UI.Xaml.GridLength(0);
